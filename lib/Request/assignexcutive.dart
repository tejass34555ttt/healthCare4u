...
import '../widgets/select_executive.dart';
import '../widgets/confirm_reason.dart';
          ...
          Column(
            children: [
              CustomButton(
                ...
                width: 350,
                backgroundColor: Color.fromARGB(255, 94, 235, 129),
              ...
              CustomButton(
                ...
                onPressed: () {
                  showDialog(
                    context: context,
                    builder: (context) => ExecutiveAlertRejectBox(),
                  );
                },
                width: 350,
